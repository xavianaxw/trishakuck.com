			...
			case('Center'): ?>
				...
				?>" <?php echo ($ag_section['backgroundstyle']) ? $ag_section['backgroundstyle'] : '' ?>>
                    <div class="container">
                        ...
                        <!-- Section Media -->
                        <div class="fourteen columns offset-by-one fullimage" style="margin-bottom:0;">
							<?php
                            // Get Featured Slideshow or Section Video
                            if (!$ag_section['sectionvideo'] || $ag_section['sectionvideo'] == '') {
				...
				?>" <?php echo ($ag_section['backgroundstyle']) ? $ag_section['backgroundstyle'] : '' ?>>
                    <div class="container">
                        ...
                        <div class="sixteen columns content">
                            <?php echo ($section_post->post_title) ? '<h3>' . apply_filters('the_title', $section_post->post_title) . '</h3><div class="clear"></div>' : ''; ?>
                                <?php echo apply_filters('the_content', $section_post->post_content); ?>
                        </div>
                        <!-- END Section Content -->
